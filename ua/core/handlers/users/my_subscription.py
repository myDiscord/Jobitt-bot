...
from ua.core.keyboards.user.menu_reply import rkb_main_menu, rkb_no_sub
from ua.core.keyboards.user.my_subscriptions_reply import ikb_my_subscriptions, rkb_subscription
