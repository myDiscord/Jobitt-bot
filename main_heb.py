...
from heb.core.handlers.routers import user_router, admin_router
from heb.core.mailing.general import check_for_mailing
from heb.core.middleware.motivator import SubMiddleware

from heb.core.settings import settings
from heb.core.utils.commands import set_commands

from heb.core.utils.db_create import check_database_exists, create_database
from heb.core.utils.technologies import make_tech_list
...
async def start():
    ...
    try:
        ...
        with open('ua/logs/main.log', 'a') as log_file:
